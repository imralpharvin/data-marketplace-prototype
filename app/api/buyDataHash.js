...
let buyDataHash = async(transaction) => {
    try {
        console.log("*****Buy Datahash SDK*****");
        let hash =  transaction["hash"];
        let buyer = transaction["buyer"];
        let seller = transaction["seller"];
        let username = transaction["buyer"];
        ...
        await contract.submitTransaction('BuyDataHash', hash, seller, buyer);
...
exports.buyDataHash = buyDataHash;
